...
<!-- Mirrored from jobpress.icookcode.net/dev/blog-grid-full-width.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Dec 2017 10:14:43 GMT -->
<head>
				...
				<div class="container">
					<div class="news-grid">
						...
						<div class="news-grid-row flex space-between">
							...
							<div class="news-item">
								<img src="images/news-grid06.jpg" alt="news-thumbnail" class="img-responsive">
								<div class="news-content">
									<div class="news-meta flex no-column">
										<h6><a href="#0" class="news-author">Nancy watson</a></h6>
										<h6 class="publish-date">20.02.2017</h6>
						...
						<div class="news-grid-row flex space-between">
							<div class="news-item">
								<img src="images/news-grid07.jpg" alt="news-thumbnail" class="img-responsive">
								<div class="news-content">
									<div class="news-meta flex no-column">
										<h6><a href="#0" class="news-author">Nancy watson</a></h6>
										<h6 class="publish-date">20.02.2017</h6>
...
<!-- Mirrored from jobpress.icookcode.net/dev/blog-grid-full-width.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Dec 2017 10:14:50 GMT -->
</html>