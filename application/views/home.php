...
<?php include ('head.php') ?>
	<body>
		...
		<header class="header">
			<div class="container clearfix">
				<div class="header-inner flex space-between items-center">
					<div class="left">
						<div class="logo"><a href="<?php base_url()?>Home"><img src="<?php base_url()?>public/images/logo.png" alt="JobPress" class="img-responsive"></a></div>
					</div> <!-- end .left -->				
	   ...
	   <?php include ('login.php') ?>
		...
		<!-- Hero Section -->
		<div class="section hero-section transparent" style="background-image: url('<?php base_url()?>public/images/background01.jpg');">
			<div class="inner">
				<div class="container">
					...
					<div class="container">
						<div class="features-bar-inner flex space-between">
							...
							<div class="features-box-icon flex no-wrap">
								<img src="<?php base_url()?>public/images/feature-icon01.png" alt="cup-icon" class="img-responsive self-center">
							...
							<div class="features-box-icon flex no-wrap">
								<img src="<?php base_url()?>public/images/feature-icon02.png" alt="cup-icon" class="img-responsive self-center">
								<div class="content self-center">
							...
							<div class="user-profile-icon self-center">
								<img src="<?php base_url()?>public/images/profile-icon01.png" alt="profile-icon" class="img-responsive self-center">
						...
						<div class="table-row">
							<div class="table-cells flex no-wrap">
								<div class="cell job-title-cell flex no-column no-wrap">
									...
									<img src="<?php base_url()?>public/images/company-logo01.jpg" alt="company-logo" class="img-responsive">
									<div class="content">
						...
						<div class="table-row">
							<div class="table-cells flex no-wrap">
								<div class="cell job-title-cell flex no-column no-wrap">
									...
									<img src="<?php base_url()?>public/images/company-logo02.jpg" alt="company-logo" class="img-responsive">
									<div class="content">
						...
						<div class="table-row">
							<div class="table-cells flex no-wrap">
								<div class="cell job-title-cell flex no-column no-wrap">
									...
									<img src="<?php base_url()?>public/images/company-logo03.jpg" alt="company-logo" class="img-responsive">
									<div class="content">
						...
						<div class="table-row">
							<div class="table-cells flex no-wrap">
								<div class="cell job-title-cell flex no-column no-wrap">
									...
									<img src="<?php base_url()?>public/images/company-logo04.jpg" alt="company-logo" class="img-responsive">
									<div class="content">
						...
						<div class="table-row">
							<div class="table-cells flex no-wrap">
								<div class="cell job-title-cell flex no-column no-wrap">
									...
									<img src="<?php base_url()?>public/images/company-logo05.jpg" alt="company-logo" class="img-responsive">
									<div class="content">
				...
				<div class="container">
					...
					<div class="category-grid">					
						<div class="category-row flex no-wrap space-between items-center">
							<div class="item">
								<img src="<?php base_url()?>public/images/category-icon01.png" alt="category-icon" class="img-responsive">
								<h4>Finance</h4>
								<p class="light">4286 Jobs</p>
							</div> <!-- end .item -->
							<div class="item">
								<img src="<?php base_url()?>public/images/category-icon02.png" alt="category-icon" class="img-responsive">
								<h4>Construction</h4>
								<p class="light">452 Jobs</p>
							</div> <!-- end .item -->
							<div class="item">
								<img src="<?php base_url()?>public/images/category-icon03.png" alt="category-icon" class="img-responsive">
								<h4>Logistics</h4>
								<p class="light">1867 Jobs</p>
							</div> <!-- end .item -->
							<div class="item">
								<img src="<?php base_url()?>public/images/category-icon04.png" alt="category-icon" class="img-responsive">
								<h4>Art/Design</h4>
								<p class="light">3094 jobs</p>
							</div> <!-- end .item -->
							<div class="item">
								<img src="<?php base_url()?>public/images/category-icon05.png" alt="category-icon" class="img-responsive">
						...
						<div class="category-row flex no-wrap space-between items-center">
							<div class="item">
								<img src="<?php base_url()?>public/images/category-icon06.png" alt="category-icon" class="img-responsive">
								<h4>Science</h4>
								<p class="light">470 Jobs</p>
							</div> <!-- end .item -->
							<div class="item">
								<img src="<?php base_url()?>public/images/category-icon07.png" alt="category-icon" class="img-responsive">
								<h4>Technologies</h4>
								<p class="light">4536 Jobs</p>
							</div> <!-- end .item -->
							<div class="item">
								<img src="<?php base_url()?>public/images/category-icon08.png" alt="category-icon" class="img-responsive">
								<h4>Healthcare</h4>
								<p class="light">2619 Jobs</p>
							</div> <!-- end .item -->	
							<div class="item">
								<img src="<?php base_url()?>public/images/category-icon09.png" alt="category-icon" class="img-responsive">
								<h4>Education/Training</h4>
								<p class="light">1132 jobs</p>
							</div> <!-- end .item -->
							<div class="item">
								<img src="<?php base_url()?>public/images/category-icon10.png" alt="category-icon" class="img-responsive">
								<h4>Food Services</h4>
						...
						<div class="table-row">
							<div class="table-cells flex no-wrap">
								<div class="cell job-title-cell flex no-column no-wrap">
									...
									<img src="<?php base_url()?>public/images/company-logo06.jpg" alt="company-logo" class="img-responsive">
									<div class="content">
										<h4><a href="job-details.html">Web Designer needed</a></h4>
						...
						<div class="table-row">
							<div class="table-cells flex no-wrap">
								<div class="cell job-title-cell flex no-column no-wrap">
									...
									<img src="<?php base_url()?>public/images/company-logo07.jpg" alt="company-logo" class="img-responsive">
									<div class="content">
										<h4><a href="job-details.html">We're hiring a fullstack developer</a></h4>
						...
						<div class="table-row">
							<div class="table-cells flex no-wrap">
								<div class="cell job-title-cell flex no-column no-wrap">
									...
									<img src="<?php base_url()?>public/images/company-logo08.jpg" alt="company-logo" class="img-responsive">
									<div class="content">
										<h4><a href="job-details.html">Looking for a project leader</a></h4>
						...
						<div class="table-row">
							<div class="table-cells flex no-wrap">
								<div class="cell job-title-cell flex no-column no-wrap">
									...
									<img src="<?php base_url()?>public/images/company-logo09.jpg" alt="company-logo" class="img-responsive">
									<div class="content">
										<h4><a href="job-details.html">Front-end developer needed</a></h4>
						...
						<div class="table-row">
							<div class="table-cells flex no-wrap">
								<div class="cell job-title-cell flex no-column no-wrap">
									...
									<img src="<?php base_url()?>public/images/company-logo10.jpg" alt="company-logo" class="img-responsive">
									<div class="content">
										<h4><a href="job-details.html">Software Engineer</a></h4>
		...
		<div class="section cta-section parallax text-center" style="background-image: url('<?php base_url()?>public/images/background02.jpg');">
			<div class="inner">
				<div class="container">
				...
				<div class="container">
					...
					<div class="news-grid">
						<div class="news-grid-row flex space-between">
							<div class="news-item">
								<img src="<?php base_url()?>public/images/news-grid01.jpg" alt="news-thumbnail" class="img-responsive">
							...
							<div class="news-item">
								<img src="<?php base_url()?>public/images/news-grid02.jpg" alt="news-thumbnail" class="img-responsive">
								<div class="news-content">
									<div class="news-meta flex no-column">
										<h6><a href="#0" class="news-author">Nancy watson</a></h6>
										<h6 class="publish-date">20.02.2017</h6>
							...
							<div class="news-item">
								<img src="<?php base_url()?>public/images/news-grid03.jpg" alt="news-thumbnail" class="img-responsive">
								<div class="news-content">
									<div class="news-meta flex no-column">
										<h6><a href="#0" class="news-author">Nancy watson</a></h6>
										<h6 class="publish-date">20.02.2017</h6>
					...
					<div class="logo-grid">
						<div class="logo-grid-row flex space-between">
							<div class="logo-item flex">
								<img src="<?php base_url()?>public/images/client-logo01.png" alt="client-company-logo" class="img-responsive self-center">
							</div> <!-- end .logo-item -->
							<div class="logo-item flex">
								<img src="<?php base_url()?>public/images/client-logo02.png" alt="client-company-logo" class="img-responsive self-center">
							</div> <!-- end .logo-item -->
							<div class="logo-item flex">
								<img src="<?php base_url()?>public/images/client-logo03.png" alt="client-company-logo" class="img-responsive self-center">
							</div> <!-- end .logo-item -->							
							<div class="logo-item flex">
								<img src="<?php base_url()?>public/images/client-logo04.png" alt="client-company-logo" class="img-responsive self-center">
							</div> <!-- end .logo-item -->
							<div class="logo-item flex">
								<img src="<?php base_url()?>public/images/client-logo05.png" alt="client-company-logo" class="img-responsive self-center">
							</div> <!-- end .logo-item -->							
							<div class="logo-item flex">
								<img src="<?php base_url()?>public/images/client-logo06.png" alt="client-company-logo" class="img-responsive self-center">
							</div> <!-- end .logo-item -->
		...
		<!-- Footer -->
		<div class="section footer transparent" style="background-image: url('<?php base_url()?>public/images/background03.jpg');">
			<div class="container">
				<div class="top flex space-between items-center">
					<img src="<?php base_url()?>public/images/footer-logo.png" alt="footer-logo" class="img-responsive">
		...
		<!-- Scripts -->
		<!-- jQuery -->		
		<script src="<?php base_url()?>public/js/jquery-3.1.1.min.js"></script>
		<!-- Bootstrap -->
		...
		<!-- Wow.js -->
		<script src="<?php base_url()?>public/js/wow.min.js"></script>
		<!-- Typehead.js -->
		<script src="<?php base_url()?>public/js/typehead.js"></script>
		<!-- Tagsinput.js -->
		<script src="<?php base_url()?>public/js/tagsinput.js"></script>
		<!-- Bootstrap Select -->
		<script src="<?php base_url()?>public/js/bootstrap-select.js"></script>
		<!-- Waypoints -->
		<script src="<?php base_url()?>public/js/jquery.waypoints.min.js"></script>
		<!-- CountTo -->
		<script src="<?php base_url()?>public/js/jquery.countTo.js"></script>
		<!-- Isotope -->
		<script src="<?php base_url()?>public/js/isotope.pkgd.min.js"></script>
		<script src="<?php base_url()?>public/js/imagesloaded.pkgd.min.js"></script>
		<!-- Magnific-Popup -->
		<script src="<?php base_url()?>public/js/jquery.magnific-popup.js"></script>
		<!-- Scripts.js -->
