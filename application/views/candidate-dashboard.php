...
<!-- Mirrored from jobpress.icookcode.net/dev/candidate-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Dec 2017 10:14:42 GMT -->
<head>
				...
				<div class="header-inner flex space-between items-center">
					...
					<div class="right flex space-between no-column items-center">
						...
						<div class="account-info-top flex items-center no-column">
							...
							<a href="#0" class="profile-button flex space-between items-center no-column no-wrap"><span>Hi!</span>Mark <img src="images/avatar01.jpg" alt="avatar" class="img-responsive"></a>
			...
			<div class="inner">
				<div class="container">
					<div class="breadcrumb-menu flex items-center no-column">
						<img src="images/candidate06.jpg" alt="avatar" class="img-responsive">
...
<!-- Mirrored from jobpress.icookcode.net/dev/candidate-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Dec 2017 10:14:43 GMT -->
</html>