...
<!-- Mirrored from jobpress.icookcode.net/dev/blog-standard.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Dec 2017 10:15:07 GMT -->
<head>
				...
				<div class="container">
					...
					<div class="blog-posts-wrapper flex space-between no-wrap">
						<div class="blog-left-side">
							...
							<div class="blog-standard">
								<img src="images/blog-post-img02.jpg" alt="blog-post-featured-img" class="img-responsive">
								<div class="blog-standard-info flex no-column no-wrap">
									<div class="left-side">
										<img src="images/avatar06.jpg" alt="post-author-img" class="img-responsive">
									</div> <!-- end .left-side -->
									<div class="right-side">
										<h2 class="dark">Employer branding: Get behind the wheel!</h2>
										<div class="news-meta flex no-column">
											<h6><a href="#0" class="news-author">Stephen bell</a></h6>
											<h6 class="publish-date">20.02.2017</h6>
											<h6><a href="#0" class="comment-count">5 comments</a></h6>
										</div> <!-- end .news-meta -->
										<p>Fusce fermentum ipsum mauris, rutrum ultrices ligula sodales et. Maecenas pellentesque aliquet arcu, vel elementum magna facilisis vitae. Nam in cursus lorem. Donec ac tellus nisl. Sed volutpat quis orci nec placerat. Fusce ex magna, congue sed vulputate rhoncus, laoreet nec sapien.</p>
							...
							<div class="blog-standard">
								<img src="images/blog-post-img03.jpg" alt="blog-post-featured-img" class="img-responsive">
								<div class="blog-standard-info flex no-column no-wrap">
									<div class="left-side">
										<img src="images/avatar07.jpg" alt="post-author-img" class="img-responsive">
									</div> <!-- end .left-side -->
									<div class="right-side">
										<h2 class="dark">How to convince recruiters and get your dream job</h2>
										<div class="news-meta flex no-column">
											<h6><a href="#0" class="news-author">Nancy watson</a></h6>
											<h6 class="publish-date">20.10.2017</h6>
											<h6><a href="#0" class="comment-count">5 comments</a></h6>
										</div> <!-- end .news-meta -->
										<p>Fusce fermentum ipsum mauris, rutrum ultrices ligula sodales et. Maecenas pellentesque aliquet arcu, vel elementum magna facilisis vitae. Nam in cursus lorem. Donec ac tellus nisl. Sed volutpat quis orci nec placerat. Fusce ex magna, congue sed vulputate rhoncus, laoreet nec sapien.</p>
										<button type="button" class="button">Read More</button>
...
<!-- Mirrored from jobpress.icookcode.net/dev/blog-standard.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Dec 2017 10:15:09 GMT -->
</html>