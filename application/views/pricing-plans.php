...
<!-- Mirrored from jobpress.icookcode.net/dev/pricing-plans.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Dec 2017 10:14:56 GMT -->
<head>
	...
	<body>
		...
		<div class="section breadcrumb-bar solid-blue-bg">
			<div class="inner">
				<div class="container">
					<p class="breadcrumb-menu"><a href="#0"><i class="ion-ios-home"></i></a><i class="ion-ios-arrow-right arrow-right"></i><a href="#0">Pricing plans</a></p>
					<h2 class="breadcrumb-title">Pricing Plans</h2>
				</div> <!-- end .container -->
			</div> <!-- end .inner -->
		</div> <!-- end .section -->
					...
					<div class="pricing-plans-row flex space-between no-wrap items-center text-center">
						<div class="pricing-plan">
							...
							<div class="price">
								...
								<h2 class="price-text"><sup>$</sup>0<sub>/forever</sub></h2>
							</div> <!-- end .price -->
							<ul class="list-unstyled features-list">
								...
								<li>30-days expired</li>
							</ul> <!-- end .features-lists -->
							<a href="#0" class="button">Get started</a>
						...
						<div class="pricing-plan">
							...
							<div class="price">
								<div class="bg-circle"></div>
								<h2 class="price-text"><sup>$</sup>99<sub>/forever</sub></h2>
							</div> <!-- end .price -->
							<ul class="list-unstyled features-list">
								<li>Post 5 job</li>
						...
						<div class="pricing-plan">
							...
							<div class="price">
								<div class="bg-circle"></div>
								<h2 class="price-text"><sup>$</sup>199<sub>/forever</sub></h2>
							</div> <!-- end .price -->
							<ul class="list-unstyled features-list">
